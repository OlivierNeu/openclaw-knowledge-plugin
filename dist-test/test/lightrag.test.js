...
describe("queryLightRAG", () => {
    ...
    it("sends correct request to LightRAG API", async () => {
        ...
        const result = await queryLightRAG("http://lightrag:9621", "my-api-key", "find my contracts", "hybrid");
    ...
    it("handles string response format", async () => {
        ...
        const result = await queryLightRAG("http://lightrag:9621", "", "query", "naive");
    ...
    it("handles response with context field", async () => {
        ...
        const result = await queryLightRAG("http://lightrag:9621", "", "query", "local");
    ...
    it("returns empty string for unexpected response shape", async () => {
        ...
        const result = await queryLightRAG("http://lightrag:9621", "", "query", "global");
        assert.equal(result, "");
    });
    ...
    it("throws on non-OK response", async () => {
        ...
        await assert.rejects(() => queryLightRAG("http://lightrag:9621", "", "q", "hybrid"), { message: /LightRAG query failed \(500\)/ });
    });
});
...
//# sourceMappingURL=lightrag.test.js.map